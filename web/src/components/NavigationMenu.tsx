      ...
      <div className="hidden lg:flex flex-col justify-between h-dvh">
        <nav className="flex lg:w-80 p-5 divide-y divide-solid flex-col gap-3 ">
          ...
          <div className="divide-y divide-solid flex flex-col">
            ...
            {/* nav section */}
            {navigationMenuOptions.map((section, key) => (
              <div key={key}>
                <h3 key={key} className="text-neutral-400 text-sm my-1">
                  {section.section}
                </h3>
                <ul>
        ...
        <footer>
          <p className="m-3 flex items-center gap-2 text-sm text-neutral-600">
            Developed by
            <a
              href="https://github.com/steph-cs"
              target="_blank"
              className="underline flex gap-2 items-center text-neutral-600"
              rel="noreferrer"
            >
              steph-cs
              <svg
